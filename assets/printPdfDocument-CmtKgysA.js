import{p as a}from"./react-pdf.browser-CVr3yMIs.js";const l=t=>String(t).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;"),p=async(t,n="Preparing document")=>{if(!t)throw new Error("The PDF document is not available for printing.");const e=window.open("","_blank");if(!e)throw new Error("Please allow pop-ups for Smartbooks to print this PDF.");const r=l(n);e.document.open(),e.document.write(`
    <!doctype html>
    <html lang="en">
      <head>
        <meta charset="utf-8" />
